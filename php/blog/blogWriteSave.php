...
<?php
    ...
    if($blogImgType){
        ...
        $sql = "INSERT INTO myBlog(myMemberID, blogTitle, blogContents, blogCategorygory, blodAuthor, blogView, blogLike, blogImgFile, blogImgSize, blogDelete, blogRegTime) VALUES('$myMemberID', '$blogTitle', '$blogContents', '$blogCategory', '$blogAuthor', '$blogView', '$blogLike', 'Img_default.jpg', '$blogImg', '$blogLike', '$regTime')";
