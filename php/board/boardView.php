        ...
        <section id="board" class="container">
            ...
            <div class="board__inner">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                // 페이지 뷰 + 1
                                $viewSql = "UPDATE myBoard SET boardView = boardView + 1 WHERE myBoardID={$myBoardID}";
                ...
                <div class="board__btn">
                    ...
                    <a href="./boardRemove.php?myBoardID=<?=$myBoardID?>" onclick="alert('정말로 삭제하시겠습니까?')">삭제하기</a>
